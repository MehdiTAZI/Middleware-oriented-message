...
CREATE TABLE "CONSUMER_EVENT" (
		...
		"EVENTSINQUEUE_ID" INTEGER NOT NULL
	);
...
CREATE INDEX "SQL110330000901460" ON "CHANNEL_EVENT" ("EVENTS_ID" ASC);

CREATE INDEX "SQL110330000901530" ON "CONSUMER_EVENT" ("EVENTSINQUEUE_ID" ASC);

CREATE UNIQUE INDEX "SQL110330000901340" ON "CHANNEL_EVENT" ("CHANNEL_ID" ASC, "EVENTS_ID" ASC);
...
CREATE UNIQUE INDEX "SQL110330000901391" ON "CONSUMER_EVENT" ("EVENTSINQUEUE_ID" ASC);

CREATE INDEX "SQL110330000901510" ON "CONSUMER_EVENT" ("CONSUMER_ID" ASC);

CREATE UNIQUE INDEX "SQL110330000901390" ON "CONSUMER_EVENT" ("CONSUMER_ID" ASC, "EVENTSINQUEUE_ID" ASC);

CREATE UNIQUE INDEX "SQL110330000901341" ON "CHANNEL_EVENT" ("EVENTS_ID" ASC);
...
ALTER TABLE "CONSUMER_EVENT" ADD CONSTRAINT "SQL110330000901390" PRIMARY KEY ("CONSUMER_ID", "EVENTSINQUEUE_ID");

ALTER TABLE "CHANNEL_EVENT" ADD CONSTRAINT "SQL110330000901340" PRIMARY KEY ("CHANNEL_ID", "EVENTS_ID");
...
ALTER TABLE "CHANNEL_EVENT" ADD CONSTRAINT "FK59A8701EDAF0B277" FOREIGN KEY ("EVENTS_ID")
	REFERENCES "EVENT" ("ID");

ALTER TABLE "CONSUMER_EVENT" ADD CONSTRAINT "FKA23A00F1DCDA057D" FOREIGN KEY ("EVENTSINQUEUE_ID")
	REFERENCES "EVENT" ("ID");
