 ...
 * 
 * implementation of the EventServerChannelAdmin IDL Interface
 * 
 ...
 * 
 */
public class EventServerChannelAdminImpl implements
	EventServerChannelAdminOperations {
    private static Logger log = LoggerFactory
	    .getLogger(EventServerChannelAdminImpl.class);

    private EventServerChannelAdminCtr eventServerChannelAdminctrl;

    /**
     * Constructor for an EventServerChannelAdmin implementation. Build the
     * underlying EventServerChannelAdminCtr.
     * 
     * @param eventServerName
     *            EventServer Name
     */
    public EventServerChannelAdminImpl(String eventServerName) {
	log.debug("Instanciation of EventServerChannelAdminImpl for {}",
		eventServerName);
	this.eventServerChannelAdminctrl = BFFactory
		.createEventServerChannelAdminCtr(eventServerName);
    }
     ...
     * @see fr.esiag.mezzodijava.mezzo.cosevent.EventServerChannelAdminOperations#createChannel(String
     *      topic, int capacity)
     * 
     */
    @Override
	...
	log.debug(
		"Creation of channel {} with a capacity of {} in EventServerChannelAdminImpl",
		topic, capacity);
     ...
     * @see fr.esiag.mezzodijava.mezzo.cosevent.EventServerChannelAdminOperations#getChannel(long
     ...
     * @throws ChannelNotFoundException
     *             If the channel doesn't exist
     * @see fr.esiag.mezzodijava.mezzo.cosevent.EventServerChannelAdminOperations#destroyChannel(long
     *      uniqueServerChannelId)
     */
    @Override
     ...
     * @see fr.esiag.mezzodijava.mezzo.cosevent.EventServerChannelAdminOperations#changeChannelCapacity(long
     *      uniqueServerChannelId, int capacity)
     */
    @Override
	...
	eventServerChannelAdminctrl.changeChannelCapacity(
		uniqueServerChannelId, capacity);
    }
