...
public abstract class PushSupplierPOA extends org.omg.PortableServer.Servant
 implements CosEvent.PushSupplierOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("receive", new java.lang.Integer (1));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // CosEvent/PushSupplier/disconnect
       {
         this.disconnect ();
         out = $rh.createReply();
         break;
       ...
       case 1:  // CosEvent/MessageListener/receive
       {
