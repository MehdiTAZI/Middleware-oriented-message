...
public class ConnectionPanel extends JFrame implements ActionListener {
	...
	public void initComponents() {
		...
		if (frame.getInformationPanel().getIdComponent().getText() != null
				&& frame.getInformationPanel().getChannelName().getText() != null) {
			idComponent.setText(frame.getInformationPanel().getIdComponent()
					.getText());
			channelName.setText(frame.getInformationPanel().getChannelName()
					.getText());
		}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (b.getText().equals("Connect")) {
			...
			try {
				...
				try {
					frame.getConsumerProxy().connect(
							frame.getCallbackConsumer());
				} catch (TRANSIENT t) {
				...
				// if(pmp.isOK()==true){
				JOptionPane.showMessageDialog(this, "The Component "
						+ idComponent.getText()
						+ " is successfully connected \n to channel "
						+ channelName.getText(), "Success Connection",
						JOptionPane.INFORMATION_MESSAGE);
				// }
				// else
				// JOptionPane.showMessageDialog(
				// this,
				// "The Component "+ idComponent.getText()
				// +" is Failled to conecting \n to channel "+channelName.getText(),
				// "Failled Connection",
				...
				JOptionPane.showMessageDialog(this, e1.getMessage(),
						"Error Channel Not Found", JOptionPane.ERROR_MESSAGE);
			} catch (NotRegisteredException e1) {
				// TODO Auto-generated catch block
				JOptionPane.showMessageDialog(this, e1.getMessage(),
						"Error Not Registred ", JOptionPane.ERROR_MESSAGE);
			} catch (MaximalConnectionReachedException e1) {
				// TODO Auto-generated catch block
				JOptionPane.showMessageDialog(this, e1.getMessage(),
						"Error Maximal Connected Reached ",
						JOptionPane.ERROR_MESSAGE);
			} catch (AlreadyConnectedException e1) {
				// TODO Auto-generated catch block
				JOptionPane.showMessageDialog(this, e1.getMessage(),
						"Error Already Connected", JOptionPane.ERROR_MESSAGE);
			}
			...
			try {
				...
				JOptionPane.showMessageDialog(this, "The Component "
						...
						+ channelName.getText(), "Success Disconnection",
						JOptionPane.INFORMATION_MESSAGE);
				...
				// TODO Auto-generated catch block
				JOptionPane.showMessageDialog(this, e1.getMessage(),
						"Error Not Connected", JOptionPane.ERROR_MESSAGE);
			}
		}
			...
			if (isConnected == true) {
				this.frame.getStatePanel().getConnectionValue()
						.setText("Connected                   ");
			} else {
				this.frame.getStatePanel().getConnectionValue()
