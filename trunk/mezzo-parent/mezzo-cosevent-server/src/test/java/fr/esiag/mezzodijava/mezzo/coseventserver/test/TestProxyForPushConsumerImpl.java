...
public class TestProxyForPushConsumerImpl {
    ...
    @Test
    public void testConnect() throws NotRegisteredException,
	...
	CallbackConsumer mockCall = EasyMock
		.createNiceMock(CallbackConsumer.class);
	// appel et valeur de retour espérée
	EasyMock.expect(mockCtr.getChannel()).andReturn(new Channel("TEST", 3));
	// inject mock in Factory
	BFFactory.setAlternateChannelCtr("TEST", mockCtr);
    ...
    @Test
    public void testDisconnect() throws NotRegisteredException,
    ...
    @Test
    public void testReceive() throws AlreadyRegisteredException,
	    ConsumerNotFoundException, AlreadyConnectedException,
