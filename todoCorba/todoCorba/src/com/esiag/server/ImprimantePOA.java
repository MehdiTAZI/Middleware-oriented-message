...
import com.esiag.client.ImprimanteHelper;
...
public abstract class ImprimantePOA extends org.omg.PortableServer.Servant
 implements ImprimanteOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // InterfaceIDL/Imprimante/printDocument
       {
         ...
         } catch (TacheRefusee $ex) {
           out = $rh.createExceptionReply ();
           TacheRefuseeHelper.write (out, $ex);
         }
         break;
       }
  ...
  {
    return (Imprimante)ImprimanteHelper.narrow(super._this_object());
  }

  public Imprimante _this(org.omg.CORBA.ORB orb) 
  {
    return (Imprimante)ImprimanteHelper.narrow(
