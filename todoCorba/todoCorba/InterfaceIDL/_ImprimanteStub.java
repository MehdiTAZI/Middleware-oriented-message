...
public class _ImprimanteStub extends org.omg.CORBA.portable.ObjectImpl implements InterfaceIDL.Imprimante
{
  ...
  public short printDocument (String nomFichier, org.omg.CORBA.IntHolder nbOctets) throws InterfaceIDL.TacheRefusee
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:InterfaceIDL/TacheRefusee:1.0"))
                    throw InterfaceIDL.TacheRefuseeHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
